...
case_to_do=read.csv(paste0('/home/hc654/NetworkExperiment/2_simulation_s/case_to_do_nat',expo1,expo2,'.csv'))
...
save_path=paste0('/home/hc654/palmer_scratch/final_analysis_Ds/' ,option,'_nat_',expo1,'_',expo2,'_FOSO_',simulation_index,'.Rdata')
