NO_HARM_AS2=function(y,d1,d0,pi0,pi1,y_p1,y_p0,so_AS2){
  

  print('In NOHARM AS2 (No Harm)')
  ...
  for (i in 1:nrow(dict_group)){
    ...
    #since cov_bound at the zero entry is zero anyway, changing the denominator does not change the result and it stableizes the numerical algebra.
...
NO_HARM2_AS2=function(y,d1,d0,pi0,pi1,y_p1,y_p0,so_AS2){
  
  print('In NOHARM2 AS2 (Optimal Imputed)')
