...
FOSO = function(net, FUN, num_status,prob,num_mappings,nrep,id_list,expo1,expo2){
...
friend_treated = function(friend_index,realized_assignment){
  ...
  num_friend_treated =c( sum(realized_assignment[friend_index]==0),sum(realized_assignment[friend_index]==1) )
