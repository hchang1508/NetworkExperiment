...
case_to_do=read.csv(paste0('/home/hc654/NetworkExperiment/2_simulation_fs/case_to_do_fs',expo1,expo2,'.csv'))

case_to_do=case_to_do[,2]
simulation_index=as.numeric(case_to_do[as.numeric(input[3])])
option='Stratified'

save_path=paste0('/home/hc654/palmer_scratch/final_analysis_D_fs/' ,option,'_fs_',expo1,'_',expo2,'_FOSO_',simulation_index,'.Rdata')
